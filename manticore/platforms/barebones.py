...
class BareBones(Platform):
    ...
    def __getstate__(self):
        state = super(BareBones, self).__getstate__()
    ...
    def __setstate__(self, state):
        ...
        """
        super(BareBones, self).__setstate__(state)
    ...
    def execute(self):
        ...
        """
        try:
	    #print "BareBones: Going to execute a cpu"
...
class SBareBones(BareBones):
    ...
    # marshaling/pickle
    def __getstate__(self):
        state = super(SBareBones, self).__getstate__()
    ...
    def __setstate__(self, state):
        ...
        super(SBareBones, self).__setstate__(state)
